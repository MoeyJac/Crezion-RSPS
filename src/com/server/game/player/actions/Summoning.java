package com.server.game.player.actions;

import java.io.Serializable;
import java.util.HashMap;
import java.util.Map;

import com.server.cache.loaders.ItemDefinitions;
import com.server.cache.loaders.NPCDefinitions;
import com.server.game.Animation;
import com.server.game.WorldObject;
import com.server.game.WorldTile;
import com.server.game.item.Item;
import com.server.game.npc.NPC;
import com.server.game.npc.familiar.Familiar;
import com.server.game.npc.others.DreadNip;
import com.server.game.player.Player;
import com.server.game.player.Skills;
...
public class Summoning implements Serializable {
	...
	public static Familiar createFamiliar(Player player, Pouches pouch) {
		String loc = "com.server.game.npc.familiar.";
		try {
	...
	public static void openDreadnipInterface(Player player) {
		...
		player.getInterfaceManager().sendTab(
				player.getInterfaceManager().hasResizableScreen() ? 115 : 175,
				1165);
	}
